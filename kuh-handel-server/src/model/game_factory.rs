...
use std::{collections::BTreeMap, rc::Arc, sync::Arc, vec};
    ...
    pub fn new_default_game(
        ...
        let players = player_ids
            ...
            .map(|(id, player_action)| {
                Player::new(id.clone(), wallet.clone(), game_stack, player_action)
            })
            .collect();

        Game::new(players, wallet, game_stack, seed, 15, 500)
    }
